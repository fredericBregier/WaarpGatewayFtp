...
public class LogExport {
   ...
   * on the value of the '-out' command line
   * argument: - if no value is given, a default path is computed (the same as
   * online export, i.e. in [data
   * directory]/[admin name]) - if the value '-' is given, destinationWriter is
   * the standard output (System.out) - if
   * any other value is given, then it is considered as the path to the
   * destination file
   *
