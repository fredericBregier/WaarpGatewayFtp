 ...
 * authentications from the file given as
 * argument or the original one if no argument is given.<br> Two optional
 * arguments exist:<br> - PURGE: empty first the
 * current authentications before applying the update<br> - SAVE: save the final
 * authentications on the original name
 * given at startup.<br>
 *
