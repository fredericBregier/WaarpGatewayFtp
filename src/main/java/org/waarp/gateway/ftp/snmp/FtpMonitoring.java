  ...
  public void initialize() {
    ...
    try {
      ...
      countInActiveTransfer =
          DbTransferLog.getCountInOutRunningPrepareStatement(dbSession,
                                                             true, true);
      ...
      countOutErrorTransfer =
          DbTransferLog.getCountInOutErrorPrepareStatement(dbSession,
                                                           false);
      // All
